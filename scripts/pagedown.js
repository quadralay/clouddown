...
(function () {
    ...
    Markdown.Editor = function (markdownConverter, elements, options) {
        options = options || {};
        ...
        this.run = function () {
            ...
            panels = new PanelCollection(elements);
    ...
    function PanelCollection(elements) {
        this.buttonBar = elements.buttonBar;
        this.preview = elements.preview;
        this.input = elements.input;
        this.fileContent = elements.fileContent;
    };
    ...
    function UndoManager(callback, panels) {
        ...
        var refreshState = function (isInitialState) {
            ...
            inputStateObj = new CLEditState(panels, isInitialState);
            timer = undefined;
        };
        ...
        this.undo = function () {
            ...
            if (undoObj.canUndo()) {
                if (lastState) {
                    ...
                    undoStack[stackPtr] = new CLEditState(panels);
        ...
        var saveState = function () {
            ...
            var currState = inputStateObj || new CLEditState(panels);
    ...
    function CLEditState(panels, isInitialState) {
        var stateObj = this;
    ...
    function PreviewManager(converter, panels, previewRefreshCallback) {
        ...
        var makePreviewHtml = function () {
            ...
            var text = panels.input.getContent();
    ...
    function UIManager(panels, undoManager, previewManager, commandManager, helpOptions, getString) {
        ...
        function doClick(button) {
            ...
            if (button.textOp) {
                ...
                var state = new CLEditState(panels);
        ...
        function makeSpritedButtonRow() {
            ...
            var makeButton = function (id, iconClass, title, XShift, textOp) {
                ...
                buttonIcon.className = "wmd-button-icon fa " + iconClass;
            ...
            var imageIcon = "fa-image";
            var olistIcon = "fa-list-ol";
            var ulistIcon = "fa-list-ul";
            var headingIcon = "fa-header";
            var hrIcon = "fa-pied-piper-alt";
            var undoIcon = "fa-arrow-left";
...
(function () {
    ...
    if (typeof exports === "object" && typeof require === "function") { // we're in a CommonJS (e.g. Node.js) module
        output = exports;
        Converter = require("../pagedown/Markdown.Converter").Converter;
    } else {
